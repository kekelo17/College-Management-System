...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-xp&w-*d@t8(@b4+i(qt5q77rx=n0tj9v(&d81gyz=$cwuotiu%')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'CMS_project.context_processors.user_context',
            ],
        },
    },
]
